...
extends ContainerTemp {
    ...
    public void setMachineInventorySlots(InventoryPlayer player) {
        ...
        this.addMachineSlotToContainer(new SlotResultWithTexture(this.tile, 1, 116, 35, RectangleTexture.LargeSlotTexture));
    }
    ...
    public boolean transferStackToMachineInventory(ItemStack itemstack1) {
        return this.func_75135_a(itemstack1, this.materialSlotIndex, this.resultSlotIndex, false);
    }

    @Override
    public boolean transferStackFromMachineInventory(ItemStack itemstack1, int slot) {
        return !(slot >= this.resultSlotIndex ? !this.transferStackToPlayerInventory(itemstack1, true) : !this.transferStackToPlayerInventory(itemstack1, false));
    }
}
