...
public class ContainerVacuumContainer
extends ContainerTemp {
    ...
    public void setMachineInventorySlots(InventoryPlayer player) {
        ...
        this.addMachineSlotToContainer(new SlotStorageContainer(tile, tile.extractSlotNum + tile.insertSlotNum - 1, (this.machineGuiSizeX - 16) / 2, 35, RectangleTexture.LargeSlotTexture));
    ...
    public boolean transferStackToMachineInventory(ItemStack itemstack1) {
        return this.func_75135_a(itemstack1, 0, 1, false);
    }
