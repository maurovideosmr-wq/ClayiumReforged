...
public class UtilLocale {
    ...
    public static String laserGui(long laser) {
        return I18n.func_135052_a((String)"gui.Common.clayLaser", (Object[])new Object[]{UtilLocale.laserNumeral(laser)});
    }

    @SideOnly(value=Side.CLIENT)
    public static String tierGui(int tier) {
        return I18n.func_135052_a((String)"gui.Common.tier", (Object[])new Object[]{tier});
    }
        ...
        while (flag && i < 12) {
            ...
            if (loc != null) {
                if (loc.equals("__DETAIL__")) {
                    if (GuiScreen.func_146272_n()) continue;
